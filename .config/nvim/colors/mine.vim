...
hi ErrorMsg term=standout cterm=bold ctermfg=15 ctermbg=1 gui=bold guifg=White guibg=Red
...
hi Comment term=bold ctermfg=7 guifg=#406090
hi Constant term=underline ctermfg=4
hi Special term=bold ctermfg=4 guifg=SlateBlue
hi Identifier term=underline cterm=bold ctermfg=NONE guifg=DarkCyan
